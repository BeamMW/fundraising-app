...
import {
  ProcessedProposal, UserViewParams, VotingAppParams, ProposalStats,
} from '@core/types';
...
export const loadPrevProposalStats = createAction('@@MAIN/LOAD_PREV_PROPOSAL_STATS')<{
  propId: number;
  stats: ProposalStats;
}>();
...
export const loadRate = createAsyncAction('@@MAIN/GET_RATE', '@@MAIN/GET_RATE_SUCCESS', '@@MAIN/GET_RATE_FAILURE')<
void,
number,
any
>();
